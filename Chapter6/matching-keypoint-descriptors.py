...
def draw_matches(img1, keypoints1, img2, keypoints2, matches):
    ...
    for match in matches:
        ...
        cv2.circle(output_img, (int(x2)+cols1, int(y2)),
                   radius, colour, thickness)
...
if __name__ == '__main__':
    ...
    print(descriptors1[1])
    print(descriptors2[1])
    # print(descriptors1[1].trainIdx)
    # print(descriptors1[1].queryIdx)
    # print(descriptors1[1].imgIdx)
    ...
    img3 = draw_matches(img1, keypoints1, img2, keypoints2, matches[:40])
